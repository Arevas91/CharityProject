    ...
    <div class="form--steps-container">
        ...
        <form:form modelAttribute="donation" method="post">
            ...
            <div data-step="1" class="active">
                ...
                <form:errors path="categoryList" cssClass="error" element="div"/>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input type="number" path="quantity" min="1" id="quantity"/>
            ...
            <div data-step="3">
                ...
                <c:forEach items="${institutions}" var="inst" varStatus="loop">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:radiobutton path="institution" value="${inst.id}" itemName="${inst.name}"/>
                            <span class="checkbox radio"></span>
                            <span class="description">
                            <div class="title">
                                <c:out value="${inst.name}"/>
                            </div>
                            <div class="subtitle">
                                <c:out value="${inst.description}"/>
                            </div>
                            </span>
                        </label>
                    </div>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Ulica <form:input type="text" path="street" id="street"/>
                            </label>
                        ...
                        <div class="form-group form-group--inline">
                            <label>
                                Miasto <form:input type="text" path="city" id="city"/>
                            </label>
                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="quantityValue">
                                </span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                                <span class="summary--text" id="forInstitution">
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            ...
                            <ul>
                                <li id="yourStreet"></li>
                                <li id="yourCity"></li>
                                <li id="yourZipCode"></li>
                                <li id="yourPhoneNumber"></li>
                            </ul>
                        </div>
